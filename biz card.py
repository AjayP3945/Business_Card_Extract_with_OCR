...
if __name__ =='__main__':
  ...
  with col2:
    #st.title(':#a5d669[Extracting Business Card Data with OCR]')
    new_title = '<p style="font-family:sans-serif; color:#a5d669; font-size: 42px;">Extracting Business Card Data with OCR</p>'
    ...
    selected = option_menu(None, ["Home", "Upload & Extract", "view", "Update_data","Download"],
                           ...
                           styles={
                               ...
                               "nav-link": {"font-size": "15px", "text-align": "left", "margin": "0px",
                                            "--hover-color": "#a5d669"},
                           "nav-link-selected": {"background-color": "#a5d669"}}
                           )

    if selected == 'Home':
      new = '<p style="font-family:sans-serif; color:#a5d669; font-size: 38px;">OCR</p>'
      ...
      st.write('')
      new1 = '<p style="font-family:sans-serif; color:#a5d669; font-size: 35px;">EasyOCR</p>'
      ...
      name = '<p style="font-family:sans-serif; color:#a5d669; font-size: 35px;">About & Contact</p>'
      st.markdown(name, unsafe_allow_html=True)
      st.write('I am Ajay P, a data Analyst')
      st.write('Please reach out me @')
      st.write('Email id : pande@8873gmail.com')
      st.write("##")
      st.write('Follow me on')
      Github = "https://github.com/AjayP3945"

      col1,  = st.columns([0.04])
      with col1:
          if st.button('Github'):
